...
export class FirstJobFormComponent implements OnInit {
  ...
  jobStoryForm: UntypedFormGroup = new UntypedFormGroup({});

  constructor(
    private userStory: UntypedFormBuilder,
  ...
  getCohort(): AbstractControl | null {
    return this.jobStoryForm.get('cohort');
  }
